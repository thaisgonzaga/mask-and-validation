...
```
cd existing_repo
git remote add origin https://gitlab.com/ifcoder/java/projetoDacc_maven_with_db.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/ifcoder/java/projetoDacc_maven_with_db/-/settings/integrations)
